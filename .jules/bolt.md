...
## 2026-04-05 - Refactored `_extract_from_tree` for maintainability
**Learning:** Overly complex functions can be refactored into smaller, specialized handlers while preserving recursive logic. This improves readability and simplifies future modifications.
**Action:** Extract logic into private methods (e.g., `_handle_class_node`, `_handle_function_node`) and delegate from the main traversal loop.
