...
## 2026-05-28 - [Embedding Sequential Fallback]
**Learning:** Cloud embedding batches can fail due to persistent issues with a single text or non-retryable errors.
**Action:** Always implement a sequential fallback in batch embedding logic to ensure partial success and robustness.
