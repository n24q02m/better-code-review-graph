...
# ⚡ Bolt: Translation table for _sanitize_name optimization.
# str.translate is significantly faster than a generator expression
...
def _sanitize_name(s: str, max_len: int = 256) -> str:
    ...
    cleaned = s.translate(_SANITIZE_TRANS_TABLE)
