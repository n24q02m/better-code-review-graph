...
class CodeParser:
    ...
    def _extract_from_tree(
        ...
        for child in root.children:
            ...
            if node_type in import_types:
                if self._handle_import_node(child, source, language, file_path, edges):
                    continue
            ...
            if node_type in call_types:
                if self._handle_call_node(
                    ...
                    # Calls don't have nested structures we care about usually,
                    # but we don't 'continue' here because there might be other
                    # things in the same node (though rare for call_types).
                    # Actually, in original code it didn't continue.
                    pass
    ...
    def _handle_call_node(
        ...
        if not (call_name and enclosing_func):
            return False
    ...
    def _handle_solidity_constructs(
        self,
        child,
        source: bytes,
        language: str,
