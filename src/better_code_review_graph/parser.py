...
class CodeParser:
    ...
    def _collect_python_import_names(
        ...
        """Process Python import_from_statement to extract names."""
    ...
    def _collect_js_import_names_from_node(
        ...
        """Extract JS/TS module path and trigger name collection."""
        module = None
        for child in node.children:
    ...
    def _process_js_named_import(
        ...
        """Process a named_imports node to extract individual specifiers."""
    ...
    def _collect_js_import_names(
        ...
        for child in clause_node.children:
            if child.type == "identifier":
                ...
                self._process_js_named_import(child, module, import_map)
